//
//  BreedsImagesCollectionViewCell.swift
//  DogsBreeds
//
...
class BreedImagesCollectionViewCell: UICollectionViewCell {
    ...
    static let identifier: String = "BreedsImagesCollectionViewCell"
...
//       configureConstraints()
    ...
    private func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            breedsImageView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -16),
